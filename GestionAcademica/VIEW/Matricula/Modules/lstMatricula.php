    ...
    <div class="container col-sm-12 ">
        <div class="card card-default">
            <div class="card-body row col" style="gap: 15px;">
                <?php
                $tbMetrics = $matriculaBL->Metricas();
        ...
        <div class="card card-default">
            <div class="card-body">
                <table id="tableData" class="table table-hover">
                    ...
                    <tbody>
                       <?php
                       $tbData = $matriculaBL->Listar();

                       foreach($tbData as $fila) {
                           ?>
                       <tr>
                           <th scope="row"><?php echo $fila['IDMatricula'];?></th>
                           ...
                           <td>
                               <a id="editar" class="btn btn-info"
                                  href="./Panel.php?case=update&id=<?php echo $fila['IDMatricula']; ?>">
                                   <i class="fa-solid fa-pencil text-white"></i>
                               </a>
                               <a id="eliminar" class="btn btn-danger"
                                  href="./Services/Serv_delete.php?id=<?php echo $fila['IDMatricula']; ?>">
