                ...
                <div class="container col">
                    <div class="row ml-0">
                        <div class="col-sm-12">
                            ...
                            <select class="form-select mb-3" name="usuario">
                                <?php
                    ...
                    <div class="row ml-0">
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control" id="nombre" name="ciclo">
                        </div>
                        <div class="col-sm-6">
                            <label for="bloque" class="form-label">Bloque Actual:</label>
