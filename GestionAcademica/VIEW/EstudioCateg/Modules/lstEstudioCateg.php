    ...
    <div class="container col-sm-12">
        <div class="card card-default">
            <div class="card-body">
                ...
                <tbody>
                    <?php
                    $tbData = $categBL->Listar();

                    foreach($tbData as $fila) {
                        ?>
                    <tr>
                        <th scope="row"><?php echo $fila['IDEstudCat'];?></th>
                        <td><?php echo $fila['Nombre']?></td>
                        <td><?php echo $fila['dt_Creacion']?></td>
                        <td><?php echo $fila['dt_Act']?></td>
                        <td>
                            <a id="editar" class="btn btn-info"
                               href="./Panel.php?case=update&id=<?php echo $fila['IDEstudCat']; ?>">
                                <i class="fa-solid fa-pencil text-white"></i>
                            </a>
                            <a id="eliminar" class="btn btn-danger"
                               href="./Services/Serv_delete.php?id=<?php echo $fila['IDEstudCat']; ?>">
