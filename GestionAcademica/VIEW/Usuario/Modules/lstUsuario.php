                ...
                <table id="tableData" class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo strtoupper($fila['Username'])?></td>
                            <td><?php echo $fila['Correo']?></td>
                            <td><?php echo $fila['dt_Creacion']?></td>
                            <td><?php echo $fila['dt_Act']?></td>
                            <td>
                                <a id="editar" class="btn btn-info"
                                   href="./Panel.php?case=update&id=<?php echo $fila['IDUsuario']; ?>">
                                    <i class="fa-solid fa-pencil text-white"></i>
                                </a>
                                <a id="eliminar" class="btn btn-danger"
                                   href="./Services/Serv_delete.php?id=<?php echo $fila['IDUsuario']; ?>">
