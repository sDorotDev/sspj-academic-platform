        ...
        <div class="card card-default">
            <div class="card-body">
                <table id="tableData" class="table table-hover">
                    ...
                    <tbody>
                        <?php
                        $tbData = $bloqueBL->Listar();

                        foreach($tbData as $fila) {
                            ?>
                        <tr>
                            <th scope="row"><?php echo $fila['IDBloque'];?></th>
                            <td><?php echo $fila['NombreCarrera']?></td>
                            <td><?php echo $fila['Seccion']?></td>
                            <td><?php echo $fila['Ciclo']?></td>
                            <td><?php echo $fila['Bloque']?></td>
                            <td><?php echo $fila['Concluido']==0 ? "No" : "Sí"; ?></td>
                            <td><?php echo $fila['dt_Inicio']?></td>
                            <td><?php echo $fila['dt_Cierre']?></td>
                            <td>
                                <a id="editar" class="btn btn-info"
                                   href="./Panel.php?case=update&id=<?php echo $fila['IDBloque']; ?>">
                                    <i class="fa-solid fa-pencil text-white"></i>
                                </a>
                                <a id="eliminar" class="btn btn-danger"
                                   href="./Services/Serv_delete.php?id=<?php echo $fila['IDBloque']; ?>">
