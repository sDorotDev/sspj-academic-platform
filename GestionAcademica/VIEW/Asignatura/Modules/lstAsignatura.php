        ...
        <div class="card card-default">
            <div class="card-body">
                <table id="tableData" class="table table-hover">
                    ...
                    <tbody>
                        <?php
                        $tbData = $asignBL->Listar();

                        foreach($tbData as $fila) {
                            ?>
                        <tr>
                            <th scope="row"><?php echo $fila['IDAsignatura'];?></th>
                            ...
                            <td>
                                <a id="editar" class="btn btn-info"
                                   href="./Panel.php?case=update&id=<?php echo $fila['IDAsignatura']; ?>">
                                    <i class="fa-solid fa-pencil text-white"></i>
                                </a>
                                <a id="eliminar" class="btn btn-danger"
                                   href="./Services/Serv_delete.php?id=<?php echo $fila['IDAsignatura']; ?>">
